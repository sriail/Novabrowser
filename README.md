...
# [Novabrowser](https://radiusproxy.app)
...
Novabrowser is a forked web proxy, based of radius. which adds additional fetures to make it a more browser-like experence.
Radius is a simple and clean web proxy designed for speed and ease-of-use, made in Astro.

Radius [Discord!](https://discord.gg/cCfytCX6Sv) (Or [TitaniumNetwork's](https://discord.gg/unblock))
...
pnpm bstart
```
Novabrowser, Like Radius, will run on port 8080 by default, or 4321 for a dev environment (`pnpm dev`).

# Credits
[srianl](https://github.com/sriail) - Owner
[Owski](https://github.com/unretain) - Owner Of Raduis <br>
